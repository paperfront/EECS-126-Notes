...
\usepackage{graphicx}
\graphicspath{ {./diagrams/} }			% Use pdf, png, jpg, or eps§ with pdflatex; use eps in DVI mode
...
\newcommand{\DBern}[2]{#1 \sim \text{Bernoulli}\left( #2 \right)}
\newcommand{\Bern}[1]{\text{Bernoulli}\left( #1 \right)}
...
\newpage
\include{multiple_random_variables}
